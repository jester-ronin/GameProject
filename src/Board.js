...
export default class Board {
    ...
    ballReachedLeftSideOfBoard(pointCoordinate) {
        ...
        let ballReachedLeftEdgeOfBoard = (this._board[0] - 1 === pointCoordinate.x && pointCoordinate.y === this._engine.rowCount - 2);
    ...
    ballReachedRightSideOfBoard(pointCoordinate) {
        ...
        let ballReachedRightEdgeOfBoard = (this._board[3] + 1 === pointCoordinate.x && pointCoordinate.y === this._engine.rowCount - 2);
